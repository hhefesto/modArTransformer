...
(() => {
  ...
  var unsafeNode = function(k, v2, l2, r) {
    ...
    ;
    throw new Error("Failed pattern match at Data.Map.Internal (line 678, column 32 - line 690, column 68): " + [l2.constructor.name]);
  };
  ...
  var unsafeBalancedNode = /* @__PURE__ */ (function() {
    var height9 = function(v2) {
      ...
      ;
      throw new Error("Failed pattern match at Data.Map.Internal (line 735, column 12 - line 737, column 26): " + [v2.constructor.name]);
    };
    ...
    return function(k, v2, l2, r) {
      ...
      ;
      throw new Error("Failed pattern match at Data.Map.Internal (line 695, column 40 - line 716, column 34): " + [l2.constructor.name]);
    };
  })();
  var $lazy_unsafeSplit = /* @__PURE__ */ $runtime_lazy3("unsafeSplit", "Data.Map.Internal", function() {
    return function(comp, k, m2) {
      ...
      if (m2 instanceof Node) {
        ...
        ;
        throw new Error("Failed pattern match at Data.Map.Internal (line 769, column 5 - line 777, column 30): " + [v2.constructor.name]);
      }
      ;
  ...
  var unsafeJoinNodes = function(v2, v1) {
    ...
    ;
    throw new Error("Failed pattern match at Data.Map.Internal (line 742, column 25 - line 746, column 38): " + [v2.constructor.name, v1.constructor.name]);
  };
    ...
    return function(k) {
      var go2 = function($copy_v) {
        ...
        function $tco_loop(v2) {
          ...
          ;
          throw new Error("Failed pattern match at Data.Map.Internal (line 278, column 8 - line 284, column 22): " + [v2.constructor.name]);
        }
        ;
        while (!$tco_done) {
      ...
      return function(v2) {
        var go2 = function(v1) {
          ...
          if (v1 instanceof Node) {
            ...
            ;
            throw new Error("Failed pattern match at Data.Map.Internal (line 469, column 7 - line 472, column 35): " + [v22.constructor.name]);
          }
          ;
    ...
    foldMap: function(dictMonoid) {
      ...
      return function(f) {
        var go2 = function(v2) {
          ...
          ;
          throw new Error("Failed pattern match at Data.Map.Internal (line 179, column 10 - line 182, column 28): " + [v2.constructor.name]);
        };
        return go2;
      };
    }
  ...
  var $$delete = function(dictOrd) {
    ...
    return function(k) {
      var go2 = function(v2) {
        ...
        ;
        throw new Error("Failed pattern match at Data.Map.Internal (line 493, column 8 - line 499, column 43): " + [v2.constructor.name]);
      };
      return go2;
    };
  };
    ...
    return function(f) {
      return function(k) {
        return function(m2) {
          ...
          ;
          throw new Error("Failed pattern match at Data.Map.Internal (line 512, column 3 - line 516, column 41): " + [v22.constructor.name]);
        };
      };
    };
  };
  ...
  // output/Halogen.Svg.Attributes.FontWeight/index.js
  var show3 = /* @__PURE__ */ show(showNumber);
  var FWeightNormal = /* @__PURE__ */ (function() {
    function FWeightNormal2() {
    }
    ;
    FWeightNormal2.value = new FWeightNormal2();
    return FWeightNormal2;
  })();
  var FWeightBold = /* @__PURE__ */ (function() {
    function FWeightBold2() {
    }
    ;
    FWeightBold2.value = new FWeightBold2();
    return FWeightBold2;
  })();
  var FWeightBolder = /* @__PURE__ */ (function() {
    function FWeightBolder2() {
    }
    ;
    FWeightBolder2.value = new FWeightBolder2();
    return FWeightBolder2;
  })();
  var FWeightNumber = /* @__PURE__ */ (function() {
    function FWeightNumber2(value0) {
      this.value0 = value0;
    }
    ;
    FWeightNumber2.create = function(value0) {
      return new FWeightNumber2(value0);
    };
    return FWeightNumber2;
  })();
  var printFontWeight = function(v2) {
    if (v2 instanceof FWeightNormal) {
      return "normal";
    }
    ;
    if (v2 instanceof FWeightBold) {
      return "bold";
    }
    ;
    if (v2 instanceof FWeightBolder) {
      return "bolder";
    }
    ;
    if (v2 instanceof FWeightNumber) {
      return show3(v2.value0);
    }
    ;
    throw new Error("Failed pattern match at Halogen.Svg.Attributes.FontWeight (line 24, column 19 - line 28, column 28): " + [v2.constructor.name]);
  };
  ...
  var renderCommand2Args = function(s_) {
    return function(ref2) {
      return function(a_2) {
        return function(b2) {
          return renderCommand(ref2)(s_) + (show4(a_2) + (", " + show4(b2)));
        };
      };
    };
  };
  ...
  var viewBox = function(x_) {
    return function(y_) {
      return function(w) {
        return function(h_) {
          return attr2("viewBox")(joinWith(" ")(map8(show6)([x_, y_, w, h_])));
        };
      };
    };
  };
  ...
  var strokeDashArray = /* @__PURE__ */ attr2("stroke-dasharray");
  ...
  var points = /* @__PURE__ */ (function() {
    ...
    var $69 = map8(function(v2) {
      return show6(v2.value0) + ("," + show6(v2.value1));
    });
    return function($70) {
      return $67($68($69($70)));
    };
  ...
  var markerEnd = /* @__PURE__ */ attr2("marker-end");
  ...
  var fontWeight = /* @__PURE__ */ (function() {
    var $94 = attr2("font-weight");
    return function($95) {
      return $94(printFontWeight($95));
    };
  })();
  ...
  var queueOrRun = function(ref2) {
    return function(au) {
      return bind12(liftEffect3(read(ref2)))(function(v2) {
        ...
        ;
        if (v2 instanceof Just) {
          return liftEffect3(write(new Just(new Cons(au, v2.value0)))(ref2));
        }
        ;
    ...
    return function(f) {
      return discard1(liftEffect3(write({
        ...
        return bind12(liftEffect3(f))(function(result) {
          return bind12(liftEffect3(read(lchs)))(function(v2) {
  ...
  var evalQ = function(render2) {
    return function(ref2) {
      return function(q3) {
        return bind12(liftEffect3(read(ref2)))(function(v2) {
          return evalM(render2)(ref2)(v2["component"]["eval"](new Query(map10(Just.create)(liftCoyoneda(q3)), $$const(Nothing.value))));
        });
      };
    };
  };
        ...
        var go2 = function(ref2) {
          return function(v1) {
            if (v1 instanceof State) {
              return bind12(liftEffect3(read(ref2)))(function(v22) {
            ...
            if (v1 instanceof Subscribe) {
              return bind12(fresh(SubscriptionId)(ref2))(function(sid) {
                return bind12(liftEffect3(subscribe(v1.value0(sid))(function(act) {
                  ...
                  return bind12(liftEffect3(read(ref2)))(function(v22) {
                    return discard1(liftEffect3(modify_2(map22(insert3(sid)(finalize)))(v22.subscriptions)))(function() {
            ...
            if (v1 instanceof Raise) {
              return bind12(liftEffect3(read(ref2)))(function(v22) {
                return bind12(liftEffect3(read(v22.handlerRef)))(function(handler3) {
                ...
                return bind12(liftEffect3(read(ref2)))(function(v22) {
                  return bind12(liftEffect3($$new(false)))(function(doneRef) {
                    return bind12(fork3($$finally(liftEffect3(function __do3() {
                      ...
                      return discard1(liftEffect3(unlessM2(read(doneRef))(modify_2(insert1(fid)(fiber))(v22.forks))))(function() {
            ...
            if (v1 instanceof Join) {
              return bind12(liftEffect3(read(ref2)))(function(v22) {
                return bind12(liftEffect3(read(v22.forks)))(function(forkMap) {
  ...
  var cleanupSubscriptionsAndForks = function(v2) {
    return function __do3() {
      bindFlipped5(traverse_23(traverse_33(unsubscribe)))(read(v2.subscriptions))();
      ...
      return function(i2) {
            ...
            return function(j) {
              return unComponent(function(c3) {
                return function __do3() {
                  ...
                  var $$var2 = initDriverState(c3)(j)(handler3)(lchs$prime)();
                  var pre2 = read(lchs)();
                  write({
                    initializers: Nil.value,
            ...
            return function(childrenInRef) {
              return function(childrenOutRef) {
                return unComponentSlot(function(slot) {
                  return function __do3() {
                    var childrenIn = map11(slot.pop)(read(childrenInRef))();
                    var $$var2 = (function() {
                    ...
                    return bind3(read($$var2))(renderStateX2(function(v2) {
                      if (v2 instanceof Nothing) {
        ...
        var render2 = function(lchs) {
          return function($$var2) {
            return function __do3() {
              var v2 = read($$var2)();
              var shouldProcessHandlers = map11(isNothing)(read(v2.pendingHandlers))();
        ...
        var evalDriver = function(disposed) {
          return function(ref2) {
            return function(q3) {
              return bind13(liftEffect4(read(disposed)))(function(v2) {
                if (v2) {
  ...
  var runUI2 = function(component2) {
    return function(i2) {
      return function(element4) {
        return bind14(liftEffect5(map15(toDocument)(bindFlipped6(document)(windowImpl))))(function(document2) {
  ...
  var What = /* @__PURE__ */ (function() {
    function What2() {
    }
    ;
    What2.value = new What2();
    return What2;
  })();
  ...
  var SelectBlock = /* @__PURE__ */ (function() {
    function SelectBlock2(value0) {
      this.value0 = value0;
    }
    ;
    SelectBlock2.create = function(value0) {
      return new SelectBlock2(value0);
    };
    return SelectBlock2;
  })();
  ...
  var yEmbed = 40;
  var yAttn = 130;
  var totalParams = "56,949";
  var svgWidth = 560;
  var style2 = /* @__PURE__ */ attr2("style");
  var paramBreakdown = "Embed 3,520 \xB7 Attn 16,768 \xB7 MLP 33,216 \xB7 Unembed 3,445";
  var handleAction = function(dictMonadAff) {
    return function(v2) {
      if (v2 instanceof SelectBlock) {
        return modify_3(function(s2) {
          var $34 = {};
          for (var $35 in s2) {
            if ({}.hasOwnProperty.call(s2, $35)) {
              $34[$35] = s2[$35];
            }
            ;
          }
          ;
          $34.selected = new Just(v2.value0);
          $34.activeTab = What.value;
          return $34;
        });
      }
      ;
      if (v2 instanceof SetTab) {
        return modify_3(function(s2) {
          ...
          ;
          $38.activeTab = v2.value0;
          return $38;
        });
      }
      ;
      throw new Error("Failed pattern match at Main (line 321, column 16 - line 323, column 54): " + [v2.constructor.name]);
    };
  };
  var gap = 8;
  var eqTab = {
    eq: function(x3) {
      return function(y3) {
        if (x3 instanceof What && y3 instanceof What) {
          return true;
        }
        ;
        if (x3 instanceof Why && y3 instanceof Why) {
          return true;
        }
        ;
        if (x3 instanceof Params && y3 instanceof Params) {
          return true;
        }
        ;
        if (x3 instanceof Shapes && y3 instanceof Shapes) {
          return true;
        }
        ;
        if (x3 instanceof Hs && y3 instanceof Hs) {
          return true;
        }
        ;
        return false;
  ...
  var eq2 = /* @__PURE__ */ eq(eqTab);
  var cxPos = /* @__PURE__ */ (function() {
    return svgWidth / 2;
  })();
  var c2 = {
    bg: "#06090f",
  ...
  var renderArrow = function(y12) {
    return function(y22) {
      return line([x1(cxPos), y1(y12), x2(cxPos), y2(y22), stroke(new Named(c2.dim)), strokeWidth(1.5), markerEnd("url(#ah)")]);
    };
  };
  var renderDim = function(x3) {
    return function(y3) {
      return function(txt) {
        return text6([x(x3), y(y3), fill(new Named(c2.dim)), style2("font-size: 10px; font-family: 'JetBrains Mono', monospace; opacity: 0.6;")])([text5(txt)]);
      };
    };
  };
  var renderEmptyInfo = /* @__PURE__ */ (function() {
    return div2([style2("padding: 40px 28px; color: " + (c2.dim + "; font-family: 'Geist', 'IBM Plex Sans', system-ui, sans-serif; text-align: center; line-height: 1.8;"))])([div2([style2("font-size: 40px; margin-bottom: 16px; opacity: 0.18;")])([text5("\u25C6")]), div2([style2("font-size: 14px; font-weight: 500;")])([text5("Click any block to explore it")]), div2([style2("font-size: 12px; margin-top: 10px; opacity: 0.55; line-height: 1.7;")])([text5("Each panel shows "), em_([text5("what")]), text5(" the layer does, "), em_([text5("why")]), text5(" it's there, parameter counts, tensor shapes, and the actual Haskell code.")]), div2([style2("margin-top: 28px; padding: 14px 18px; background: #0a0e18; border-radius: 6px; " + ("border: 1px solid " + (c2.panelBdr + "; font-size: 11.5px; text-align: left; line-height: 1.8; font-family: 'JetBrains Mono', monospace;")))])([div2([style2("color: " + (c2.dim + "; margin-bottom: 4px;"))])([text5("Total learnable parameters")]), div2([style2("color: " + (c2.accent + "; font-size: 16px; font-weight: 700;"))])([text5(totalParams)]), div2([style2("color: " + (c2.dim + "; margin-top: 10px; font-size: 10.5px; line-height: 1.7;"))])([text5(paramBreakdown)])])]);
  })();
  var renderFooter = /* @__PURE__ */ (function() {
    return div2([style2("padding: 7px 22px; border-top: 1px solid " + (c2.panelBdr + ("; " + ("font-size: 10px; color: " + (c2.dim + "; display: flex; gap: 20px; flex-shrink: 0; font-family: 'JetBrains Mono', monospace;")))))])([span_([text5("post-norm \xB7 no causal mask \xB7 AdamW + cosine LR")]), span3([style2("margin-left: auto;")])([text5("p=53 \xB7 dModel=64 \xB7 dFF=256 \xB7 dK=64 \xB7 batch=32")])]);
  })();
  var renderHeader = /* @__PURE__ */ (function() {
    return div2([style2("padding: 13px 22px; border-bottom: 1px solid " + (c2.panelBdr + "; display: flex; align-items: baseline; gap: 14px; flex-shrink: 0;"))])([span3([style2("font-size: 15px; font-weight: 800; color: " + (c2.bright + "; letter-spacing: -0.02em;"))])([text5("Modular Arithmetic Transformer")]), span3([style2("font-size: 11px; color: " + (c2.dim + ";"))])([text5("1 layer \xB7 1 head \xB7 d=64 \xB7 (a+b) mod 53")]), span3([style2("margin-left: auto; font-size: 10.5px; color: " + (c2.dim + "; font-family: 'JetBrains Mono', monospace;"))])([text5(totalParams + " params")])]);
  })();
      ...
      return function(activeTab) {
        return function(accentColor) {
          return button([onClick(function(v2) {
            return new SetTab(tab);
          }), style2("background: none; border: none; cursor: pointer; " + ("padding: 10px 13px; font-size: 11.5px; font-weight: 600; " + ("font-family: 'Geist', 'IBM Plex Sans', system-ui, sans-serif; " + ("color: " + ((function() {
            var $44 = eq2(tab)(activeTab);
            if ($44) {
              return accentColor;
            }
            ;
            ...
            var $45 = eq2(tab)(activeTab);
            if ($45) {
              return accentColor;
            }
            ;
            return "transparent";
          })() + "; margin-bottom: -1px; transition: color 0.15s;"))))))))])([text5(label5)]);
        };
      };
    };
  };
  var renderTabContent = function(block) {
    return function(tab) {
      var isMono = eq2(tab)(Hs.value) || (eq2(tab)(Params.value) || eq2(tab)(Shapes.value));
      var isCode = eq2(tab)(Hs.value);
      var fontStyle = (function() {
        if (isMono) {
          return "font-family: 'JetBrains Mono', 'Fira Code', monospace; font-size: 12.5px; line-height: 1.7;";
        }
        ;
        return "";
      })();
      var content3 = (function() {
        if (tab instanceof What) {
          return block.what;
        }
        ;
        if (tab instanceof Why) {
          return block.why;
        }
        ;
        if (tab instanceof Params) {
          return block.params;
        }
        ;
        if (tab instanceof Shapes) {
          return block.shapes;
        }
        ;
        if (tab instanceof Hs) {
          return block.hs;
        }
        ;
        throw new Error("Failed pattern match at Main (line 659, column 15 - line 664, column 21): " + [tab.constructor.name]);
      })();
      var codeStyle = (function() {
        if (isCode) {
          return "font-size: 12px; line-height: 1.65; background: #060a12; padding: 18px 22px;";
        }
        ;
        return "";
      })();
      var baseStyle = "padding: 18px 22px; font-size: 13px; line-height: 1.8; " + ("color: " + (c2.txt + "; white-space: pre-wrap; "));
      return div2([style2(baseStyle + (fontStyle + codeStyle))])([text5(content3)]);
    };
  };
  var renderBlockInfo = function(block) {
    return function(activeTab) {
      return div2([style2("font-family: 'Geist', 'IBM Plex Sans', system-ui, sans-serif;")])([div2([style2("padding: 16px 22px 12px; border-bottom: 1px solid " + (c2.panelBdr + "; display: flex; align-items: center; gap: 10px;"))])([div2([style2("width: 10px; height: 10px; border-radius: 50%; " + ("background: " + (block.color + ("; box-shadow: 0 0 10px " + (block.color + "44; flex-shrink: 0;")))))])([]), div2([style2("font-size: 14px; font-weight: 700; color: " + (c2.bright + "; letter-spacing: -0.01em;"))])([text5(block.label)])]), div2([style2("display: flex; border-bottom: 1px solid " + (c2.panelBdr + "; padding: 0 14px;"))])([renderTab("What")(What.value)(activeTab)(block.color), renderTab("Why")(Why.value)(activeTab)(block.color), renderTab("Params")(Params.value)(activeTab)(block.color), renderTab("Shapes")(Shapes.value)(activeTab)(block.color), renderTab("Haskell")(Hs.value)(activeTab)(block.color)]), renderTabContent(block)(activeTab)]);
    };
  };
  var blocks = /* @__PURE__ */ (function() {
    return [{
      id: "embed",
      label: "Embedding",
      sub: "Token + Position \u2192 \u211D\xB2\u02E3\u2076\u2074",
      color: c2.accent,
      bg: "#0d1a2a",
      what: "Each integer a, b \u2208 [0..52] is looked up in a learned embedding table (53 rows \xD7 64 cols) to produce a dense 64-dim vector. A separate positional embedding (2 rows \xD7 64 cols) is added so the model knows which operand is which.\n\nBoth tables are learned end-to-end via backpropagation \u2014 there is no hand-designed encoding.",
...
The 2\xD72 attention matrix controls how much of operand b's representation gets mixed into operand a's (and vice versa). No causal mask \u2014 both tokens see each other freely, appropriate since addition is commutative.`,
      params: "Wq  64\xD764 + bq 64  =  4,160\nWk  64\xD764 + bk 64  =  4,160\nWv  64\xD764 + bv 64  =  4,160\nW\u2092  64\xD764 + b\u2092 64  =  4,160\nLayerNorm \u03B3,\u03B2      =    128\n\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\nSubtotal             16,768",
      hs: "qs = map (linearForward attnWq) xs\nks = map (linearForward attnWk) xs\nvs = map (linearForward attnWv) xs\n\n-- scale factor\nsf = 1 / sqrt (fromIntegral dK)\n\n-- 2\xD72 attention weights\nweights = [ softmax $ scale sf $\n              fromList [qi <.> kj | kj <- ks]\n          | qi <- qs ]\n\n-- weighted sum of values\nattended = [ \u03A3\u2C7C w\u1D62\u2C7C \xB7 v\u2C7C | w\u1D62 <- weights ]\n\n-- output projection + residual + layernorm\nouts = map (linearForward attnWo) attended\nresidual = zipWith (+) embedded outs\nln1Out = map (layerNormForward ln1) residual",
      shapes: "Q, K, V      \u2208  \u211D\xB2\u02E3\u2076\u2074\nraw scores   \u2208  \u211D\xB2\u02E3\xB2   (before softmax)\nweights      \u2208  \u211D\xB2\u02E3\xB2   (after softmax, rows sum to 1)\nattended     \u2208  \u211D\xB2\u02E3\u2076\u2074\nattnOut      \u2208  \u211D\xB2\u02E3\u2076\u2074  (after W\u2092, residual, LayerNorm)"
    }, {
      id: "mlp",
      label: "MLP",
      sub: "64 \u2192 256 \u2192 ReLU \u2192 64",
      color: c2.orange,
      bg: c2.orangeBg,
      what: "Two linear layers with ReLU between them, applied independently to each token:\n  hidden = ReLU(W\u2081 \xB7 x + b\u2081)      64 \u2192 256  (expand)\n  out    = W\u2082 \xB7 hidden + b\u2082       256 \u2192 64   (compress)\n\nThe 4\xD7 expansion ratio (64 \u2192 256) is standard. ReLU zeroes negative activations, providing the essential nonlinearity.\n\nIncludes residual connection and LayerNorm (post-norm).",
...
Then a single linear layer projects from \u211D\u2076\u2074 to \u211D\u2075\xB3 (one logit per possible answer class). Softmax converts raw logits to a valid probability distribution over [0..52].

  readout = head tokens           (take token 0)
  logits = W \xB7 readout + b        (64 \u2192 53)
...
Token 0 is designated as the "answer" position \u2014 through attention, it has already gathered all the information it needs from token 1.`,
      params: "W  53\xD764 + b 53  =  3,445\n\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\nSubtotal            3,445",
      hs: "readout = head ln2Out  -- first token only\nlogits = linearForward unembed readout\nprobs  = softmax logits",
      shapes: "\u211D\xB2\u02E3\u2076\u2074  \u2192  \u211D\u2076\u2074 (token 0)  \u2192  logits \u2208 \u211D\u2075\xB3  \u2192  probs \u2208 \u0394\u2075\xB2\n(\u0394\u2075\xB2 = probability simplex, sums to 1)"
    }, {
      id: "result",
      label: "Result",
      ...
      shapes: "probs \u2208 \u0394\u2075\xB2  \u2192  prediction \u2208 [0..52]\n              \u2193  (training)\n         loss \u2208 \u211D  (scalar)\n              \u2193  backprop\n       \u2207\u03B8 loss \u2208 \u211D\u2075\u2076\u1427\u2079\u2074\u2079  (gradients for all params)\n              \u2193  AdamW\n          \u0394\u03B8  \u2208 \u211D\u2075\u2076\u1427\u2079\u2074\u2079  (parameter updates)"
    }];
  })();
  var findBlock = function(id3) {
    return find2(function(b2) {
      return b2.id === id3;
    })(blocks);
  };
  var renderInfoPane = function(state3) {
    return div2([style2("flex: 1; overflow-y: auto; background: " + (c2.panel + ";"))])([(function() {
      var v2 = bind4(state3.selected)(findBlock);
      if (v2 instanceof Nothing) {
        return renderEmptyInfo;
      }
      ;
      if (v2 instanceof Just) {
        return renderBlockInfo(v2.value0)(state3.activeTab);
      }
      ;
      throw new Error("Failed pattern match at Main (line 577, column 7 - line 579, column 60): " + [v2.constructor.name]);
    })()]);
  };
  var blockWidth = 330;
  var blockHeight = 54;
  var renderBlock = function(id3) {
    return function(y3) {
      return function(selected2) {
        var v2 = findBlock(id3);
        if (v2 instanceof Nothing) {
          return g([])([]);
        }
        ;
        if (v2 instanceof Just) {
          var isSelected = eq12(selected2)(new Just(id3));
          var strokeColor = (function() {
            if (isSelected) {
              return v2.value0.color;
            }
            ;
            return c2.bdr;
          })();
          ...
          return g([onClick(function(v1) {
            return new SelectBlock(id3);
          }), style2("cursor: pointer;")])([rect([x(cxPos - blockWidth / 2), y(y3), width8(blockWidth), height8(blockHeight), rx(6), fill(new Named(fillColor)), stroke(new Named(strokeColor)), strokeWidth(strokeW), style2("transition: all 0.15s;")]), text6([x(cxPos), y(y3 + 22), textAnchor(AnchorMiddle.value), fill(new Named(v2.value0.color)), fontWeight(FWeightBold.value), style2("font-size: 14px; font-family: 'JetBrains Mono', 'Fira Code', monospace;")])([text5(v2.value0.label)]), text6([x(cxPos), y(y3 + 40), textAnchor(AnchorMiddle.value), fill(new Named(c2.dim)), style2("font-size: 10px; font-family: 'JetBrains Mono', monospace;")])([text5(v2.value0.sub)])]);
        }
        ;
        throw new Error("Failed pattern match at Main (line 509, column 3 - line 548, column 12): " + [v2.constructor.name]);
      };
    };
  };
  var svgHeight = /* @__PURE__ */ (function() {
    return yResult + blockHeight + 40;
  })();
  var renderSvg = function(state3) {
    return svg([viewBox(0)(0)(svgWidth)(svgHeight), style2("display: block; width: 100%;")])([defs([])([marker([id2("ah"), markerWidth(8), markerHeight(6), refX(7), refY(3), orient(AutoOrient.value)])([polygon([points([new Tuple(0, 0), new Tuple(8, 3), new Tuple(0, 6)]), style2("fill: " + (c2.dim + ";"))])]), marker([id2("ah-back"), markerWidth(8), markerHeight(6), refX(1), refY(3), orient(AutoOrient.value)])([polygon([points([new Tuple(8, 0), new Tuple(0, 3), new Tuple(8, 6)]), style2("fill: " + (c2.orange + ";"))])])]), text6([x(cxPos), y(24), textAnchor(AnchorMiddle.value), fill(new Named(c2.bright)), fontWeight(FWeightBold.value), style2("font-size: 13px; font-family: 'JetBrains Mono', monospace;")])([text5("Inputs:  a, b  \u2208 [0..52]")]), renderBlock("embed")(yEmbed)(state3.selected), renderArrow(yEmbed + blockHeight + gap)(yAttn - gap), renderBlock("attn")(yAttn)(state3.selected), renderArrow(yAttn + blockHeight + gap)(yMlp - gap), renderBlock("mlp")(yMlp)(state3.selected), renderArrow(yMlp + blockHeight + gap)(yUnembed - gap), renderBlock("unembed")(yUnembed)(state3.selected), renderArrow(yUnembed + blockHeight + gap)(yResult - gap), renderBlock("result")(yResult)(state3.selected), renderDim(cxPos + blockWidth / 2 + 14)(yEmbed + 32)("\u211D\xB2\u02E3\u2076\u2074"), renderDim(cxPos + blockWidth / 2 + 14)(yAttn + 32)("\u211D\xB2\u02E3\u2076\u2074"), renderDim(cxPos + blockWidth / 2 + 14)(yMlp + 32)("\u211D\xB2\u02E3\u2076\u2074"), renderDim(cxPos + blockWidth / 2 + 14)(yUnembed + 32)("\u211D\u2075\xB3"), renderDim(cxPos + blockWidth / 2 + 14)(yResult + 32)("[0..52]"), path([d([m(Abs.value)(cxPos - blockWidth / 2 - 20)(yResult + blockHeight / 2), l(Abs.value)(cxPos - blockWidth / 2 - 20)(yEmbed + blockHeight / 2)]), fill(NoColor.value), stroke(new Named(c2.orange)), strokeWidth(2), strokeDashArray("6,4"), markerEnd("url(#ah-back)"), style2("opacity: 0.7;")]), text6([transform([new Translate(cxPos - blockWidth / 2 - 32, (yEmbed + yResult + blockHeight) / 2), new Rotate(-90, 0, 0)]), textAnchor(AnchorMiddle.value), fill(new Named(c2.orange)), style2("font-size: 10px; font-family: 'JetBrains Mono', monospace; opacity: 0.8;")])([text5("AdamW backprop")]), text6([x(cxPos), y(svgHeight - 8), textAnchor(AnchorMiddle.value), fill(new Named(c2.bright)), style2("font-size: 12px; font-family: 'JetBrains Mono', monospace; opacity: 0.6;")])([text5("prediction:  (a + b) mod 53")])]);
  };
  var renderDiagramPane = function(state3) {
    return div2([style2("flex: 0 0 52%; overflow-y: auto; padding: 14px 6px; " + ("border-right: 1px solid " + (c2.panelBdr + ";")))])([renderSvg(state3)]);
  };
  var render = function(state3) {
    return div2([style2("display: flex; flex-direction: column; height: 100vh; width: 100vw; " + ("background: " + (c2.bg + ("; color: " + (c2.txt + "; overflow: hidden; font-family: 'Geist', 'IBM Plex Sans', system-ui, sans-serif;")))))])([renderHeader, div2([style2("display: flex; flex: 1; min-height: 0; overflow: hidden;")])([renderDiagramPane(state3), renderInfoPane(state3)]), renderFooter]);
  };
  ...
  var main2 = /* @__PURE__ */ runHalogenAff(/* @__PURE__ */ bind(bindAff)(/* @__PURE__ */ liftEffect(monadEffectAff)(function __do2() {
    ...
    var v2 = bind4(mRoot)(fromElement);
    if (v2 instanceof Nothing) {
      return pure9(unit);
    }
    ;
    if (v2 instanceof Just) {
      return $$void7(runUI2(component1)(unit)(v2.value0));
    }
    ;
    throw new Error("Failed pattern match at Main (line 698, column 3 - line 700, column 50): " + [v2.constructor.name]);
  }));
